...
namespace DataObject
{
    ...
    /// </summary>  
    public sealed class ClsDALSqlDataAccessLayer
    {

        #region private utility methods & constructors

        /// <summary>
        /// This is used for initializing connection string from web.config
        ///</summary>
        private string connectionString = "";
        public ClsDALSqlDataAccessLayer()
        {
            connectionString = ConfigurationManager.ConnectionStrings["ConnectionString"].TrimString();
        ...
        //public ClsDALSqlDataAccessLayer(string SbsDb)
        //{
        //    connectionString = ConfigurationManager.ConnectionStrings[SbsDb].TrimString();
        //}
        /// <summary>
        ...
        /// </summary>
        /// <remarks>
        /// /// This method provides  access to output parameters or the stored procedure's return value parameter.
        /// e.g.:  
        ///  int result = ExecuteNonQuery(connString, CommandType.StoredProcedure, "PublishOrders", new SqlParameter("@prodid", 24));
        /// </remarks>
        ...
        /// <returns>An int representing the number of rows affected by the command</returns>
        /// 
        public string ExecuteNonQuery(CommandType commandType, string commandText, int OverLoadVar, params SqlParameter[] commandParameters)
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                // Call the overload that takes a connection in place of the connection string
                return ExecuteNonQuery(connection, commandType, commandText, OverLoadVar, commandParameters);
            }
        }

        public string ExecuteNonQuery(SqlConnection connection, CommandType commandType, string commandText, int OverLoadVar, params SqlParameter[] commandParameters)
        {
        ...
        /// <summary>
        /// This enum is used to indicate whether the connection was provided by the caller, or created by SqlDataAccessLayer, so that
        /// we can set the appropriate CommandBehavior when calling ExecuteReader()
        /// </summary>
        private enum SqlConnectionOwnership
        {
            /// <summary>Connection is owned and managed by SqlDataAccessLayer</summary>
            Internal,
        ...
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        /// <param name="commandParameters">An array of SqlParameters to be associated with the command or 'null' if no parameters are required</param>
        /// <param name="connectionOwnership">Indicates whether the connection parameter was provided by the caller, or created by SqlDataAccessLayer</param>
        /// <returns>SqlDataReader containing the results of the command</returns>
        public string BindUserInfo(string strEmpId)
        {
            string strQ = "";
            strQ = "Select First_Name + ' ' + Last_Name from tbl_Employee where Emp_id='" + strEmpId + "'";
            return (string)ExecuteScalar(CommandType.Text, strQ);
        }
        ...
        /// by a user defined name (probably the actual table name)
        /// </param>    
        public void FillDataset(SqlConnection connection, CommandType commandType,
            string commandText, DataSet dataSet, string[] tableNames)
        {
        ...
        /// </param>
        /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
        public void FillDataset(SqlConnection connection, string spName,
            DataSet dataSet, string[] tableNames,
            params object[] parameterValues)
        {
            if (connection == null) throw new ArgumentNullException("connection");
        ...
        /// by a user defined name (probably the actual table name)
        /// </param>
        public void FillDataset(SqlTransaction transaction, CommandType commandType,
            string commandText,
            DataSet dataSet, string[] tableNames)
        {
        ...
        /// </param>
        /// <param name="parameterValues">An array of objects to be assigned as the input values of the stored procedure</param>
        public void FillDataset(SqlTransaction transaction, string spName,
            DataSet dataSet, string[] tableNames,
            params object[] parameterValues)
        {
            if (transaction == null) throw new ArgumentNullException("transaction");
        ...
        #region Return Sql Connection

        internal SqlConnection Fn_Return_SqlConnection()
        {
            if (connectionString == null || connectionString.Length == 0) throw new ArgumentNullException("connectionString");

            // Create  a SqlConnection, and Return 
            SqlConnection connection = new SqlConnection(connectionString);
            return connection;
    ...
    public sealed class SqlHelperParameterCache
    {
        ...
        {
            connectionString = ConfigurationManager.ConnectionStrings["connStr"].TrimString();
        }
